...
export default function AllArticles() {
  ...
  const handleCreateArticle = () => {
    // Navigate to a create article page, which you may need to create
    // navigate('/create-article');
    alert("Create article functionality is not yet implemented.");
  };
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">All Articles</h1>
          ...
          <div className="text-center py-12">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                It looks like there are no articles here yet. Why not be the first to create one?
              </p>
              <button
                onClick={handleCreateArticle}
