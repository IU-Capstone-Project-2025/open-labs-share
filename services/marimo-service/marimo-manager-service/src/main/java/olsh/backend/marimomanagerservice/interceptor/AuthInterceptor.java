package olsh.backend.marimomanagerservice.interceptor;
...
import olsh.backend.marimomanagerservice.service.AuthService;
...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        if (requireAuth == null) {
            log.trace("No @RequireAuth annotation found for {}, skipping authentication",
