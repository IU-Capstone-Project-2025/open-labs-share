...
import olsh.backend.marimoservice.repository.ComponentSessionRepository;
...
public class SessionService {
    ...
    public ComponentSession startSession(String componentId, String userId, String sessionName) {
        ...
        // Call Python service to start the actual Marimo kernel session
        try {
            pythonMarimoServiceClient.startSession(sessionId, component.getNotebookPath());
        } catch (Exception e) {
        ...
        ComponentSession session = ComponentSession.builder()
                ...
                .expiresAt(LocalDateTime.now().plusHours(1)) // Hardcoded TTL
                .build();
    ...
    public void endSession(String sessionId) {
        ...
        try {
            ...
            // The client already logs the error and returns a failed response.
