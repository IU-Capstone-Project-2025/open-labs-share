...
public class Hyena extends Predator
{
    ...
    public Hyena(boolean randomAge, Field field, Location location)
    {
        ...
        if(randomAge) 
        {
            ...
            foodLevel = rand.nextInt(PORCUPINE_FOOD_VALUE);
        }
        else 
        {
            age = 0;
    ...
    /**
     * Creates a new instance of a hyena
     */
    protected Animal newOffspring(boolean randomAge, Field field, Location location)
    {
        Animal offspring;
        offspring = new Hyena(false, field, location);
        return offspring;
    }
    
    /**
     * Return the max food level of a hyena
     */
